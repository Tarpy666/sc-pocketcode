...
**Fleet designation:** `sc-pocketcode` · Part of the Counted fleet.

## Abstract

Catrobat-style mobile scratch: project import/export, media packs, touch interactions. This repository ships a self-contained, deterministic implementation:
